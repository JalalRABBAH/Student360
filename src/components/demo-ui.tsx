...
import {
  ArrowDownRight, ArrowRight, ArrowUpRight, CircleAlert, Clock3, Filter,
...
export function StudentAvatar({ student, size = "md" }: { student: { initials: string; name: string }; size?: "sm" | "md" | "lg" }) {
