...
Object.assign(
  translations,
  {
  "Your schedule, class pulse and priority actions.": { fr: "Votre emploi du temps, le pouls des classes et les actions prioritaires.", ar: "جدولك اليومي، نبض الصفوف، والإجراءات ذات الأولوية." },
  "Across your assignments": { fr: "Sur vos séances", ar: "على حصصك" },
  "Some classes still pending": { fr: "Certaines classes restent à saisir", ar: "بعض الصفوف ما زالت قيد الإدخال" },
  "All classes entered": { fr: "Toutes les classes sont saisies", ar: "تم إدخال كل الصفوف" },
  "Submissions awaiting feedback": { fr: "Rendus en attente de retour", ar: "تسليمات بانتظار الملاحظات" },
  "Attention or watch signals": { fr: "Signaux d'attention ou de vigilance", ar: "إشارات انتباه أو متابعة" },
  "Today's timetable": { fr: "Emploi du temps du jour", ar: "جدول اليوم" },
  "Class in progress": { fr: "Cours en cours", ar: "حصة جارية الآن" },
  "No classes scheduled today.": { fr: "Aucun cours prévu aujourd'hui.", ar: "لا توجد حصص مجدولة اليوم." },
  "Latest school events": { fr: "Derniers événements de l'école", ar: "أحدث أحداث المدرسة" },
  "No recent events.": { fr: "Aucun événement récent.", ar: "لا توجد أحداث حديثة." },
  "My day": { fr: "Ma journée", ar: "يومي" },
  "Check-in today": { fr: "Bilan du jour", ar: "الحساب اليومي" },
  "Not submitted yet": { fr: "Non soumis pour le moment", ar: "لم يُقدَّم بعد" },
  "Homework due": { fr: "Devoirs à rendre", ar: "واجبات مستحقة" },
  "Across visible classes": { fr: "Sur les classes visibles", ar: "عبر الصفوف الظاهرة" },
  "Items due": { fr: "Échéances du jour", ar: "مستحقة اليوم" },
  "Review queue": { fr: "File de relecture", ar: "قائمة المراجعة" },
  "All submissions reviewed": { fr: "Tous les rendus sont relus", ar: "تمت مراجعة كل التسليمات" },
  "No assignments match your search.": { fr: "Aucun devoir ne correspond à votre recherche.", ar: "لا توجد واجبات تطابق بحثك." },
  "Assignments, submission progress and completion patterns.": { fr: "Devoirs, avancement des rendus et tendances de complétion.", ar: "الواجبات وتقدم التسليم وأنماط الإنجاز." },
  "Overdue": { fr: "En retard", ar: "متأخر" },
  "Daily register and attendance patterns.": { fr: "Registre quotidien et tendances de présence.", ar: "السجل اليومي وأنماط الحضور." },
  "Visible students": { fr: "Élèves visibles", ar: "الطلبة الظاهرون" },
  "Not recorded": { fr: "Non enregistré", ar: "غير مسجل" },
  "Teacher input that feeds the longitudinal student profile.": { fr: "Les apports des enseignants qui nourrissent le profil longitudinal de l'élève.", ar: "مدخلات المعلمين التي تغذي الملف الطولي للطالب." },
  "Across visible students": { fr: "Sur les élèves visibles", ar: "عبر الطلبة الظاهرين" },
  "Attention signals": { fr: "Signaux d'attention", ar: "إشارات انتباه" },
  "No observations match your search.": { fr: "Aucune observation ne correspond à votre recherche.", ar: "لا توجد ملاحظات تطابق بحثك." },
  "Quizzes, tests and projects with progress context.": { fr: "Quiz, tests et projets avec contexte de progression.", ar: "اختبارات وامتحانات ومشاريع مع سياق التقدم." },
  "Assessments without results": { fr: "Évaluations sans résultats", ar: "تقييمات بدون نتائج" },
  "Recent vs previous": { fr: "Récents vs précédents", ar: "الأخيرة مقابل السابقة" },
  "No assessments match your search.": { fr: "Aucune évaluation ne correspond à votre recherche.", ar: "لا توجد تقييمات تطابق بحثك." },
  "Participation this week": { fr: "Participation cette semaine", ar: "المشاركة هذا الأسبوع" },
  "{positive} student(s) progressing, {stable} stable, {watch} worth a check-in.": { fr: "{positive} élève(s) en progression, {stable} stables, {watch} à surveiller.", ar: "{positive} طالب(ة) في تقدم، {stable} مستقرون، {watch} بحاجة إلى متابعة." },
  "{count} attention signal(s) are open; each suggestion links to visible evidence.": { fr: "{count} signal(s) d'attention ouverts ; chaque suggestion renvoie à des preuves visibles.", ar: "{count} إشارة انتباه مفتوحة؛ كل اقتراح يربط بأدلة مرئية." },
  "Respond to support signals": { fr: "Répondre aux signaux de soutien", ar: "الرد على إشارات الدعم" },
  "Review homework submissions": { fr: "Relire les rendus de devoirs", ar: "مراجعة تسليمات الواجبات" },
  "Complete attendance for the remaining classes": { fr: "Compléter la présence pour les classes restantes", ar: "استكمال الحضور للصفوف المتبقية" },
  "Check-in participation": { fr: "Participation aux bilans", ar: "المشاركة في الحسابات اليومية" },
  "All indicators stable compared with the previous period": { fr: "Tous les indicateurs sont stables par rapport à la période précédente", ar: "كل المؤشرات مستقرة مقارنة بالفترة السابقة" },
  "Keep an eye": { fr: "À surveiller", ar: "بحاجة إلى متابعة" },
}
);